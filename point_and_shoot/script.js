...
class Raven {
    constructor() {
        ...
        this.x = canvas.width;
        this.y = Math.random() * (canvas.height - this.height); //Math.random * (canvas.height - this.height);
...
class Explosion {
    constructor(x, y, size) {
        ...
        this.sound.src = "sounds/fire_impact.wav";
...
function drawGameOver() {
    ...
    ctx.fillStyle = "white";
    ctx.fillText("GAME OVER! \n Your Score is " + score + ".", canvas.width/2+5, canvas.height/2+5);
}
